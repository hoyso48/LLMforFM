...
def _get_files(path_or_paths: PathOrPaths) -> list[Path]:
    """
    Takes a path or list of paths and returns a list of file paths.
    If a directory is provided, it returns all files inside.
    """
    if isinstance(path_or_paths, list):
        # If it's a list, ensure all are Path objects
