...
RESULTS_DIR="$BASE/results_kadtk_passt"
LOG_DIR="$BASE/logs"
LOG_FILE="$LOG_DIR/kadtk_passt_summaries.txt"
...
echo "==== KADTK PASST BATCH START $(date) ====" | tee -a "$LOG_FILE"
...
echo -e "==== KADTK PASST BATCH END $(date) ====\n" | tee -a "$LOG_FILE" 